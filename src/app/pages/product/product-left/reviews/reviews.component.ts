...
import { Rating, DinamicRating, DinamicReviews } from '../../../../funtions';
...
export class ReviewsComponent implements OnInit {
   ...
   ngOnInit(): void {
      ...
      let arrayReview = []; //Necesitamos un array vacío para almacenar los review
      ...
      arrayReview.sort(); //Ordenamos el array de mayor a menor
      ...
      arrayReview.forEach((value, index, arr) => {
         ...
         let first_index = arr.indexOf(value)    //Tomamos del array completo el primer índice de cada valor
         let last_index = arr.lastIndexOf(value) //Tomamos del array completo el último índice de cada valor

         //Comparamos si tanto el primer índice como el último índice del mismo valor son diferentes, 
         //si es diferente significa que se repite varias veces, si son iguales significa que nunca se repite
         if (first_index !== last_index) {

            objectStar[value] += 1 //incrementamos valores repetidos en las propiedades del objeto Star

         } else {

            objectStar[value] += 1 //incrementamos valores que no se repiten en las propiedades del objeto Star
      ...
      for (let i = 5; i > 0; i--) {
         ...
         //Hacemos una regla de 3: la cantidad que suma cada estella multiplicado por 100 dividido en la cantidad de calificaciones
