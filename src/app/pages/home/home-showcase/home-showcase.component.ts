   ...
   callback(indexes) {
      ...
      if (this.render) {
         ...
         this.categories.forEach(category => {
            ...
            /*=======================================================================================
            Tomamos la colección de las sub-categorías filtrando con los nombres de las categorías
            =========================================================================================*/
            ...
            this.subCategoriesService.getFilterData("category", category.name)
               .subscribe(resp => {
                  ...
                  /*===============================================================================================
                  Recorremos este nuevo array de objetos para buecar coincidencias con los nombres de categorías
                  =================================================================================================*/
            ...
            .subscribe(resp => {
               ...
               /*===========================================================================================
               Recorremos el array de objetos nuevo para buecar coincidencias con las url´s de categorías
               =============================================================================================*/
                     ...
                     if (arrayProducts[i].offer != "") { //si viene oferta
                        ...
                        if(today < offerDate){
                           ...
                           if (type == "Disccount") {
                              ...
                              //Fixed
                              offer = Number((value));
                              //value = Math.round((offer * 100) / arrayProducts[i].price); //mostrar el porcentaje que está pagando
